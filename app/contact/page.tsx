      ...
      <div className="mx-auto max-w-6xl px-4 md:px-6">
        ...
        <div className="grid lg:grid-cols-2 gap-12">
          ...
          <div className="bg-white p-8 rounded-3xl shadow-sm border border-slate-100">
            ...
            <form className="space-y-5" onSubmit={(e) => e.preventDefault()}>
              <div className="grid md:grid-cols-2 gap-5">
                <input type="text" placeholder="Adınız Soyadınız" className="w-full p-4 rounded-xl border border-slate-200 focus:ring-2 focus:ring-[#7C3AED] outline-none" />
                <input type="email" placeholder="E-posta Adresiniz" className="w-full p-4 rounded-xl border border-slate-200 focus:ring-2 focus:ring-[#7C3AED] outline-none" />
              </div>
              <input type="text" placeholder="Konu" className="w-full p-4 rounded-xl border border-slate-200 focus:ring-2 focus:ring-[#7C3AED] outline-none" />
              <textarea placeholder="Projenizden kısaca bahsedin..." rows={4} className="w-full p-4 rounded-xl border border-slate-200 focus:ring-2 focus:ring-[#7C3AED] outline-none" />
              <button className="w-full md:w-auto px-8 py-4 bg-[#7C3AED] text-white font-bold rounded-xl hover:bg-[#6b1add] transition-all flex items-center justify-center gap-2">
                Mesajı Gönder <MessageCircle size={18} />
              </button>
            </form>
          </div>
          ...
          <div className="space-y-6">
            ...
            {/* Harita Placeholder (Google Maps Embed buraya gelecek) */}
